...
/**
 * Синглтон класс для управления базой данных задач.
 */
public class DBHelper {
    ...
    /**
     * Добавление задачи в DB
     *
     * @param name нащвание задачи.
     */
    ...
    /**
     * Обновление параметра выполнения задачию
     *
     * @param id id Задачи
     * @return Получилось ли выполнить задачу или нет.
     */
    ...
    /**
     * Возвращает всю таблицу ввиде контейнера.
     *
     * @return список из TaskData.
     */
